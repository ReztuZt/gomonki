...
<div class="card">
    ...
    <script>
        document.getElementById("downloadLink").addEventListener("click", function() {
            // Pengaturan URL untuk mengunduh file PDF
            var url = "<?= base_url('payment/detail/' . $ssw->payment_id) ?>";

            // Membuat elemen anchor yang tersembunyi
            var hiddenAnchor = document.createElement("a");
            hiddenAnchor.href = url;
            hiddenAnchor.target = "_blank"; // Buka tautan di tab atau jendela baru
            hiddenAnchor.download = "nama_file.pdf"; // Nama file untuk diunduh

            // Menambahkan elemen anchor yang tersembunyi ke dalam dokumen
            document.body.appendChild(hiddenAnchor);

            // Mengklik tautan tersembunyi untuk memicu unduhan
            hiddenAnchor.click();

            // Menghapus elemen anchor tersembunyi setelah proses unduhan selesai
            setTimeout(function() {
