            ...
            <main>
                <div class="row contacts">
                    ...
                    <div class="col invoice-details">
                        ...
                        <div class="date">Bulan : <?php echo $bulan_teks; ?></div>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-left">
                                ...
                                <a><?php echo $peserta->magang_deskripsi; ?> </a>
                            </td>
                            <td class="unit">1</td>
                            <td class="qty"> <?php echo $peserta->magang_harga; ?></td>
                            <td class="total"> <?php echo $peserta->magang_harga; ?></td>
                        </tr>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td> <?php echo $peserta->magang_harga; ?></td>
                        </tr>
                    </tfoot>
                </table>
