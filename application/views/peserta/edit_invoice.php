                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="program_nama1" name="program_nama1">
                                            <?php foreach ($programs as $program) : ?>
                                                <option value="<?php echo $program['program_nama']; ?>" <?php echo ($program['program_nama'] == $invoice->program_nama1) ? 'selected' : ''; ?>><?php echo $program['program_nama']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="program_harga1" id="program_harga1" value="<?= isset($invoice->program_harga1) ? $invoice->program_harga1 : '' ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="program_nama2" name="program_nama2">
                                            <?php foreach ($programs as $program) : ?>
                                                <option value="<?php echo $program['program_nama']; ?>" <?php echo ($program['program_nama'] == $invoice->program_nama2) ? 'selected' : ''; ?>><?php echo $program['program_nama']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="program_harga2" id="program_harga2" value="<?= isset($invoice->program_harga2) ? $invoice->program_harga2 : '' ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
